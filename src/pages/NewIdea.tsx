...
import { ArrowLeft, Lightbulb, Upload, MapPin } from 'lucide-react';
...
export default function NewIdea() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const submitData: IdeaCreateData = {
      ...formData,
    ...
    try {
      await createIdea(submitData, user);
      toast({
        title: "Ideia enviada com sucesso!",
        description: "Sua ideia está sendo avaliada pela equipe de inovação.",
      });
      navigate('/dashboard');
    } catch (error) {
      toast({
